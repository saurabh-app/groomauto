...
public class RepairFragment extends Fragment {
    ...
    EditText vnext, adext, sdext, rqext;
    Spinner spinner;
    ImageView dateimg;
    Button sbbtn;
    Calendar calendar;
...
//    private SwipeRefreshLayout mSwipeRefreshLayout;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.activity_repair, container, false);
...
//        });
        ...
        //server get data that urls................

        jsonObjectRequest = new JsonObjectRequest(Request.Method.POST, "", null, new Response.Listener<JSONObject>() {
            @Override
        ...
        sbbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!preferences.getBoolean("isLogin", false)) {
                ...
                } else if (Validation.isEmpty(adext)) {
                    adext.setError("Enter Your Address");
                    ...
                    try {
                        ...
                        jsonObject.put("address", adext.getText().toString());
                        jsonObject.put("bdate", sdext.getText().toString());
                        jsonObject.put("note", rqext.getText().toString());
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
