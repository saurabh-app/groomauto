...
//    String salt="ZhraT96O"; // live
   ...
   String action1 ="";
    ...
    String SUCC = "https://www.payumoney.com/mobileapp/payumoney/success.php" ; // failed
    String FAIL = "https://www.payumoney.com/mobileapp/payumoney/failure.php" ;

    Handler mHandler = new Handler();


    static String getFirstName, getNumber, getEmailAddress, getRechargeAmt,booking_id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /* getFirstName    = "names";
        getNumber       ="9090909009";
        getEmailAddress = "names@gmail.com";
        getRechargeAmt  = "100";*/
        booking_id= getIntent().getStringExtra("bid");
        sername = getIntent().getStringExtra("Service_name");
        getRechargeAmt = getIntent().getStringExtra("Service_price");
		uid = getIntent().getStringExtra("uid");
		getFirstName = getIntent().getStringExtra("uname");
		getEmailAddress = getIntent().getStringExtra("uemail");
		getNumber = getIntent().getStringExtra("uphone");
            ...
            mHandler.post(new Runnable() {
                public void run() {
                    mHandler = null;
                     ...
                     finish();*/
                   // new PostRechargeData().execute();
                    Intent intent=new Intent(PayMentGateWay.this,PaymentSuccess.class);
                    intent.putExtra("booking_id",booking_id);
                    intent.putExtra("test",getFirstName);
                    intent.putExtra("package_name",sername);
                    intent.putExtra("package_price",getRechargeAmt);
                    startActivity(intent);
        ...
        public void failure(final String id, String error) {
            mHandler.post(new Runnable() {
                ...
                public void run() {
                    ...
                    Intent intent1=new Intent(PayMentGateWay.this,HomeActivity.class);
                   /* intent1.putExtra("test",getFirstName);
                    intent1.putExtra("package_name",sername);
                    intent1.putExtra("package_price",getRechargeAmt);*/
